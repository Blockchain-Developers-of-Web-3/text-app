...
export default function App() {
	...
	const draw = (e) => {
		...
		const subTextOffset = drawWrappedText(
			context,
			0,
	...
	return (
		<StyledMain>
			<StyledAside>
				...
				<h3>Coloring</h3>
					<label htmlFor="mtcolor-input">Main Text Color in Hex (e.g. #FFFFFF)</label>
					<input id="mtcolor-input" type="text" onChange={draw} />
				<InputGroupDiv>
					<label htmlFor="stcolor-input">Sub Text Color in Hex (e.g. #5AAB93)</label>
					<input id="stcolor-input" type="text" onChange={draw} />
				</InputGroupDiv>
				<InputGroupDiv>
					<label htmlFor="bgcolor-input">Background Color in Hex (e.g. #0B1741)</label>
